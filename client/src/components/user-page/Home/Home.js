    ...
    <>
      ...
      <section className="hero">
        <div className="hero__slider owl-carousel">
          <div className="hero__items set-bg" data-setbg="http://localhost:8081/mf_img/hero/hero-1.jpg">
          ...
          <div className="hero__items set-bg" data-setbg="http://localhost:8081/mf_img/hero/hero-2.jpg">
            <div className="container">
              <div className="row">
                <div className="col-xl-5 col-lg-7 col-md-8">
                  <div className="hero__text">
          ...
          <div className="row product__filter">
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-1.jpg">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-2.jpg">
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/search.png" alt="" /></a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
              <div className="product__item sale">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-3.jpg">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-4.jpg">
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/search.png" alt="" /></a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-5.jpg">
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/search.png" alt="" /></a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
              <div className="product__item sale">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-6.jpg">
                  <span className="label">Sale</span>
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-7.jpg">
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/search.png" alt="" /></a></li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
              <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg="http://localhost:8081/mf_img/product/product-8.jpg">
                  <ul className="product__hover">
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/heart.png" alt="" /></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/compare.png" alt="" /> <span>Compare</span></a></li>
                    <li><a href="#"><img src="http://localhost:8081/mf_img/icon/search.png" alt="" /></a></li>
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="instagram__pic">
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-1.jpg"></div>
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-2.jpg"></div>
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-3.jpg"></div>
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-4.jpg"></div>
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-5.jpg"></div>
                <div className="instagram__pic__item set-bg" data-setbg="http://localhost:8081/mf_img/instagram/instagram-6.jpg"></div>
              </div>
            </div>
            <div className="col-lg-4">
